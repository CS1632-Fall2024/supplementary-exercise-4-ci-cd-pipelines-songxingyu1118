...
public class RentACatIntegrationTest {
	...
	public void setUp() throws Exception {
		...
		c1 = Cat.createInstance(InstanceType.IMPL, 1, "Jennyanydots");// TODO: Fill in
		...
		c2 = Cat.createInstance(InstanceType.IMPL, 2, "Old Deuteronomy");// TODO: Fill in

		// 4. Create a Cat with ID 3 and name "Mistoffelees", assign to c3 using a call to Cat.createInstance(InstanceType, int, String).
		c3 = Cat.createInstance(InstanceType.IMPL, 3, "Mistoffelees");// TODO: Fill in
	...
	public void testGetCatNullNumCats0() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		assertEquals("Invalid cat ID." + newline, out.toString());// TODO: Fill in
	}
	...
	public void testListCatsNumCats0() {
		assertEquals("", r.listCats());// TODO: Fill in
	}
	...
	public void testRenameNumCat3() {
		...
		assertEquals("Garfield", c2.getName());;// TODO: Fill in
	}
