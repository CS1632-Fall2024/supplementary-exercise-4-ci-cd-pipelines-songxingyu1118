...
public class RentACatUnitTest {
	...
	public void setUp() throws Exception {
		...
		r = RentACat.createInstance(InstanceType.IMPL);// TODO: Fill in
		...
		c1 = Cat.createInstance(InstanceType.MOCK, 1, "Jennyanydots");// TODO: Fill in
		...
		c2 = Cat.createInstance(InstanceType.MOCK, 2, "Old Deuteronomy");// TODO: Fill in

		c3 = Cat.createInstance(InstanceType.MOCK, 3, "Mistoffelees");// 4. Create a Cat with ID 3 and name "Mistoffelees", assign to c3 using a call to Cat.createInstance(InstanceType, int, String).
		// TODO: Fill in
		...
		System.setOut(new PrintStream(out));// TODO: Fill in.  Refer to the textbook chapter 14.6 on Testing System Output.
	}
	...
	public void testGetCatNumCats3() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		assertEquals(2, id);// TODO: Fill in
	}
	...
	public void testRenameNumCat3() {
		...
		Mockito.verify(c2).renameCat("Garfield");// TODO: Fill in
	}
